...
```bash
apptainer pull oras://ghcr.io/utia-gc/fastqc-summary:v2.1.0
```
...
```bash
uv tool install git+https://github.com/utia-gc/fastqc-summary@v2.1.0
```

Run FastQC Summary in a temporary environment managed by uv:

```bash
uvx git+https://github.com/utia-gc/fastqc-summary@v2.1.0
```
...
python3 -m pip install git+https://github.com/utia-gc/fastqc-summary@v2.1.0
```
...
```bash
apptainer exec oras://ghcr.io/utia-gc/fastqc-summary:v2.1.0 fastqc-summary
```
